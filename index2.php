...
<body>
   ...
   <header>
      ...
      <nav id="nav-wrap">         
         ...
         <ul id="nav" class="nav">
            <li><a class="smoothscroll" href="#features">Features</a></li>
	         <li><a class="smoothscroll" href="#pricing">Registro de estudiantes</a></li>
            <li><a class="smoothscroll" href="#screenshots">Estudiantes disponibles</a></li>
      ...
      <ul class="header-social">
         ...
         <li><a href="/Woo10/index.html"> Cerrar sesión</a></li>
      </ul>
      ...
      <div class="container">
         <div class="w3ls_logo_nav">
            ...
            <!-- home -->              
                        ...
                        <div class="group">
                          <form action="regprof2.php" method="POST">

                        <center> 
                          <h2 ><em>Registro</em></h2>  
                         
                              <label for="nombre">Nombre <span></span></label>
                              <div style="position: center;"><input type="text" name="nombre" class="form-input" required/></div>
                             

                            
                              <label  for="email">Email <span><em></em></span></label>
