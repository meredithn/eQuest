   ...
   <section id="hero">
	   ...
	   <div class="row">
		   ...
		   <div class="twelve columns">
            ...
            <div class="buttons">
               <a class="button trial" href="#">Login</a>
               <a class="button learn-more smoothscroll" href="#features">Register</a>
            </div>
            ...
            <!-- home -->              
                        ...
                        <center> 
                          <h2 ><em>Formulario de Registro</em></h2>  
                             ...
                             <center> <input class="form-btn" name="submit" type="submit" value="Inscribirse" /> 
                             </center>
                            </p>
                          </form>
                        </div>
